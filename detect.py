...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='data/samples/uq', help='source')  # input file/folder, 0 for webcam
    parser.add_argument('--output', type=str, default='output/uq', help='output folder')  # output folder
